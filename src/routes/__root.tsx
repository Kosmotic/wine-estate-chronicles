...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Estate Reserve Collective is a luxury wine e-commerce platform offering curated selections, subscriptions, and immersive brand storytelling." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Estate Reserve Collective is a luxury wine e-commerce platform offering curated selections, subscriptions, and immersive brand storytelling." },
